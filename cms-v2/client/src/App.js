...
export default function App() {
    return (_jsx(BrowserRouter, { children: _jsxs(Routes, { children: [_jsx(Route, { path: "/login", element: _jsx(Login, {}) }), _jsx(Route, { path: "/reset-password", element: _jsx(ResetPassword, {}) }), _jsxs(Route, { element: _jsx(RequireAuth, { children: _jsx(Layout, {}) }), children: [_jsx(Route, { index: true, element: _jsx(Navigate, { to: "/header", replace: true }) }), _jsx(Route, { path: "/header", element: _jsx(Header, {}) }), _jsx(Route, { path: "/blog-header", element: _jsx(BlogHeader, {}) }), _jsx(Route, { path: "/footer", element: _jsx(Footer, {}) }), _jsx(Route, { path: "/banner", element: _jsx(Banner, {}) }), _jsx(Route, { path: "/promotion-section", element: _jsx(PromotionSection, {}) }), _jsx(Route, { path: "/contact-footer", element: _jsx(ContactFooter, {}) }), _jsx(Route, { path: "/home-hero", element: _jsx(HomeHero, {}) }), _jsx(Route, { path: "/about-us", element: _jsx(AboutUs, {}) }), _jsx(Route, { path: "/course-hero", element: _jsx(CourseHero, {}) }), _jsx(Route, { path: "/course-hero-right", element: _jsx(CourseHeroRight, {}) }), _jsx(Route, { path: "/course-desc", element: _jsx(CourseDesc, {}) }), _jsx(Route, { path: "/course-tabs", element: _jsx(CourseTabs, {}) }), _jsx(Route, { path: "/hero-section-v2", element: _jsx(HeroSectionV2, {}) }), _jsx(Route, { path: "/program-cards", element: _jsx(ProgramCards, {}) }), _jsx(Route, { path: "/program-cards-v2", element: _jsx(ProgramCardsV2, {}) }), _jsx(Route, { path: "/feature-cards", element: _jsx(FeatureCards, {}) }), _jsx(Route, { path: "/feature-cards-v2", element: _jsx(FeatureCardsV2, {}) }), _jsx(Route, { path: "/feature-cards-v3", element: _jsx(FeatureCardsV3, {}) }), _jsx(Route, { path: "/feature-cards-v4", element: _jsx(FeatureCardsV4, {}) }), _jsx(Route, { path: "/step-cards", element: _jsx(StepCards, {}) }), _jsx(Route, { path: "/vertical-cards", element: _jsx(VerticalCards, {}) }), _jsx(Route, { path: "/gradient-banner-section", element: _jsx(GradientBannerSection, {}) }), _jsx(Route, { path: "/legal-page", element: _jsx(LegalPage, {}) }), _jsx(Route, { path: "/team", element: _jsx(Team, {}) }), _jsx(Route, { path: "/faq", element: _jsx(FAQ, {}) }), _jsx(Route, { path: "/forms/:type", element: _jsx(Forms, {}) }), _jsx(Route, { path: "/events", element: _jsx(Events, {}) }), _jsx(Route, { path: "/articles", element: _jsx(Articles, {}) }), _jsx(Route, { path: "/blog", element: _jsx(Blog, {}) }), _jsx(Route, { path: "/full-screen/:type", element: _jsx(FullScreenSections, {}) }), _jsx(Route, { path: "/split-screen/:type", element: _jsx(SplitScreenSections, {}) }), _jsx(Route, { path: "/page-desc-with-menu", element: _jsx(PageDescWithMenu, {}) }), _jsx(Route, { path: "/split-screen-sections", element: _jsx(Navigate, { to: "/split-screen/left-hero", replace: true }) }), _jsx(Route, { path: "/settings/users", element: _jsx(RequireAdmin, { children: _jsx(UserManagement, {}) }) }), _jsx(Route, { path: "/settings/menu", element: _jsx(RequireAdmin, { children: _jsx(MenuManagement, {}) }) })] })] }) }));
}
