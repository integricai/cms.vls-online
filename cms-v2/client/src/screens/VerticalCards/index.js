...
export default function VerticalCardsScreen() {
    ...
    useEffect(() => {
        api.get('/content/vls-vertical-cards')
            .then(row => {
            const raw = row?.data;
            let comps = [];
            if (raw?.components) {
