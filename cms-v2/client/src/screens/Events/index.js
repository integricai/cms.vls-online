...
export default function Events() {
    ...
    return (_jsxs("div", { className: "flex h-full", children: [_jsxs("div", { className: "w-[480px] shrink-0 overflow-y-auto border-r border-slate-200 bg-white", children: [_jsxs("div", { className: "sticky top-0 z-10 border-b border-slate-100 bg-white px-5 py-4", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx("h1", { className: "text-base font-bold text-slate-900", children: "Events" }), _jsxs("span", { className: "ml-auto text-xs text-slate-400", children: [events.length, " events"] })] }), _jsxs("div", { className: "mt-3 flex gap-2", children: [_jsx("button", { className: "btn-ghost text-xs", onClick: () => { setHtml(wrapGeneratedHtml('Events', buildEventsListEmbedCode(publicEventsUrl()))); setMode('html'); }, children: "List Embed" }), _jsx("button", { className: "btn-primary text-xs", onClick: () => startNew(), children: "+ New Event" })] })] }), _jsx("div", { className: "max-h-72 overflow-y-auto border-b border-slate-100", children: sorted.length ? sorted.map(event => {
