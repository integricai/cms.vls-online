...
function ColorPair({ label, value, onChange }) {
    return (_jsx(Field, { label: label, children: _jsxs("div", { className: "flex items-center gap-2", children: [_jsx("input", { type: "color", value: value, onChange: e => onChange(e.target.value), className: "h-9 w-10 shrink-0 cursor-pointer rounded border border-slate-300 p-0.5" }), _jsx("input", { type: "text", value: value, className: "input", onChange: e => {
                        if (/^#[0-9a-fA-F]{6}$/.test(e.target.value))
                            onChange(e.target.value);
                    } })] }) }));
}
function buildInjectCode(price) {
    return `<script>
(function(){
...
function CoursePriceForm({ price, onChange }) {
    ...
    return (_jsxs("div", { className: "space-y-0", children: [_jsx("p", { className: "section-label", children: "Identity" }), _jsx(Field, { label: "Price card ID", hint: "Embedded in the inject code and page target", children: _jsx("input", { className: "input select-all bg-slate-50 font-mono text-slate-500", value: price.id, readOnly: true }) }), _jsx(Field, { label: "Price card name", hint: "CMS only", children: _jsx("input", { className: "input", value: price.name, placeholder: "e.g. FA1 course price", onChange: e => onChange({ name: e.target.value }) }) }), _jsx(Field, { label: "Status", children: _jsxs("select", { className: "input", value: String(price.visible), onChange: e => onChange({ visible: e.target.value === 'true' }), children: [_jsx("option", { value: "true", children: "Visible - update cards on pages" }), _jsx("option", { value: "false", children: "Hidden - hide matching cards" })] }) }), _jsx("p", { className: "section-label", children: "Course" }), _jsx(Field, { label: "Eyebrow", children: _jsx("input", { className: "input", value: price.eyebrow, onChange: e => onChange({ eyebrow: e.target.value }) }) }), _jsx(Field, { label: "Course title", children: _jsx("input", { className: "input", value: price.title, onChange: e => onChange({ title: e.target.value }) }) }), _jsx("p", { className: "section-label", children: "Pricing" }), _jsxs("div", { className: "grid grid-cols-3 gap-2", children: [_jsx(Field, { label: "Currency", children: _jsx("input", { className: "input", value: price.currency, onChange: e => onChange({ currency: e.target.value }) }) }), _jsx(Field, { label: "Regular price", children: _jsx("input", { type: "number", min: 0, step: "0.01", className: "input", value: price.regularPrice, onChange: e => onChange({ regularPrice: Number(e.target.value) }) }) }), _jsx(Field, { label: "Discount %", children: _jsx("input", { type: "number", min: 0, max: 100, step: "0.01", className: "input", value: price.discountPercent, onChange: e => onChange({ discountPercent: Number(e.target.value) }) }) })] }), _jsxs("div", { className: "mb-3 rounded border border-emerald-200 bg-emerald-50 px-3 py-2 text-xs text-emerald-800", children: ["Your Price: ", _jsxs("span", { className: "font-bold", children: [price.currency, money(calc.yourPrice)] }), " \u00B7 Saving: ", _jsxs("span", { className: "font-bold", children: [price.currency, money(calc.saving)] })] }), _jsx(Field, { label: "Price label", children: _jsx("input", { className: "input", value: price.priceLabel, onChange: e => onChange({ priceLabel: e.target.value }) }) }), _jsx(Field, { label: "Saving text prefix", children: _jsx("input", { className: "input", value: price.savingPrefix, onChange: e => onChange({ savingPrefix: e.target.value }) }) }), _jsx("p", { className: "section-label", children: "Includes" }), _jsx(Field, { label: "Includes label", children: _jsx("input", { className: "input", value: price.includesLabel, onChange: e => onChange({ includesLabel: e.target.value }) }) }), _jsx("div", { className: "mb-2 space-y-2", children: price.includes.map((item, index) => (_jsxs("div", { className: "flex gap-2", children: [_jsx("input", { className: "input", value: item, onChange: e => updateInclude(index, e.target.value) }), _jsx("button", { className: "btn-danger shrink-0 text-xs", onClick: () => onChange({ includes: price.includes.filter((_, i) => i !== index) }), children: "\u2715" })] }, index))) }), _jsx("button", { className: "btn-ghost mb-3 w-full text-xs", onClick: () => onChange({ includes: [...price.includes, ''] }), children: "+ Add include item" }), _jsx("p", { className: "section-label", children: "CTA" }), _jsx(Field, { label: "Button text", children: _jsx("input", { className: "input", value: price.ctaText, onChange: e => onChange({ ctaText: e.target.value }) }) }), _jsx(Field, { label: "Button URL", children: _jsx("input", { className: "input", value: price.ctaUrl, onChange: e => onChange({ ctaUrl: e.target.value }) }) }), _jsx(Field, { label: "Refund note", children: _jsx("input", { className: "input", value: price.refundText, onChange: e => onChange({ refundText: e.target.value }) }) }), _jsx("p", { className: "section-label", children: "Colours" }), _jsxs("div", { className: "grid grid-cols-2 gap-2", children: [_jsx(ColorPair, { label: "Background", value: price.bg, onChange: value => onChange({ bg: value }) }), _jsx(ColorPair, { label: "Border", value: price.border, onChange: value => onChange({ border: value }) }), _jsx(ColorPair, { label: "Accent", value: price.accent, onChange: value => onChange({ accent: value }) }), _jsx(ColorPair, { label: "Discount background", value: price.discountBg, onChange: value => onChange({ discountBg: value }) }), _jsx(ColorPair, { label: "Discount text", value: price.discountTc, onChange: value => onChange({ discountTc: value }) }), _jsx(ColorPair, { label: "Saving background", value: price.saveBg, onChange: value => onChange({ saveBg: value }) })] }), _jsx(Field, { label: "Border radius (px)", children: _jsx("input", { type: "number", min: 0, max: 40, className: "input", value: price.radius, onChange: e => onChange({ radius: Number(e.target.value) }) }) })] }));
}
export default function CoursePriceScreen() {
    ...
    useEffect(() => {
        api.get('/content/vls-course-prices')
            .then(row => {
            const items = row?.data?.prices ?? [];
            items.forEach(item => {
    ...
    return (_jsxs("div", { className: "flex h-full", children: [_jsxs("div", { className: "w-[440px] shrink-0 overflow-y-auto border-r border-slate-200 bg-white", children: [_jsxs("div", { className: "sticky top-0 z-10 border-b border-slate-100 bg-white px-5 py-4", children: [_jsx("h1", { className: "text-base font-bold text-slate-900", children: "Course Prices" }), _jsx("p", { className: "mt-0.5 text-xs text-slate-400", children: "Price cards - paste inject code once, publish updates live" })] }), _jsxs("div", { className: "space-y-2 border-b border-slate-100 bg-white px-5 py-3", children: [_jsxs("div", { className: "grid grid-cols-2 gap-2", children: [_jsx("button", { onClick: saveAndGenerate, disabled: saving || !active, className: "btn-primary justify-center text-xs", children: saving ? 'Saving…' : saved ? '✓ Saved' : '💾 Save & Generate HTML' }), _jsx("button", { onClick: publish, disabled: publishing || !active, className: "btn-success justify-center text-xs", children: publishing ? 'Publishing…' : published ? '✓ Published' : '🚀 Publish Price' })] }), publishError && _jsx("p", { className: "rounded border border-red-200 bg-red-50 px-3 py-2 text-xs text-red-600", children: publishError }), _jsxs("div", { className: "space-y-1 rounded border border-slate-200 bg-slate-50 px-3 py-2", children: [_jsxs("p", { className: "text-[11px] text-slate-500", children: ["Add ", _jsxs("span", { className: "font-mono", children: ["data-vls-price-card=\"", active?.id || 'cp1', "\""] }), " to the live course card container."] }), _jsxs("p", { className: "text-[11px] text-slate-500", children: ["Optional fields: ", _jsx("span", { className: "font-mono", children: "regular" }), ", ", _jsx("span", { className: "font-mono", children: "discount" }), ", ", _jsx("span", { className: "font-mono", children: "price" }), ", ", _jsx("span", { className: "font-mono", children: "amount" }), ", ", _jsx("span", { className: "font-mono", children: "saving" }), ", ", _jsx("span", { className: "font-mono", children: "saveText" }), ", ", _jsx("span", { className: "font-mono", children: "cta" }), "."] })] })] }), _jsxs("div", { className: "px-5 py-4", children: [_jsxs("div", { className: "mb-4", children: [_jsxs("div", { className: "mb-2 flex items-center justify-between", children: [_jsx("span", { className: "text-xs font-semibold uppercase tracking-widest text-slate-400", children: "Price cards" }), _jsx("button", { onClick: addPrice, className: "btn-ghost px-2 py-1 text-xs", children: "+ New" })] }), prices.length === 0 ? (_jsx("p", { className: "py-4 text-center text-sm text-slate-400", children: "No price cards yet." })) : (_jsx("div", { className: "space-y-1", children: prices.map(price => (_jsxs("div", { onClick: () => selectPrice(price.id), className: `flex cursor-pointer items-center justify-between rounded-lg px-3 py-2 text-sm transition ${price.id === activeId
                                                ? 'bg-brand text-white'
                                                : 'border border-slate-200 bg-white text-slate-700 hover:border-brand/40'}`, children: [_jsxs("div", { className: "flex min-w-0 items-center gap-2", children: [_jsx("span", { className: `text-xs ${price.id === activeId ? 'text-white/70' : 'text-slate-400'}`, children: price.visible ? '●' : '○' }), _jsx("span", { className: "truncate font-medium", children: price.name || price.title || 'Untitled' })] }), _jsx("button", { onClick: event => {
                                                        event.stopPropagation();
                                                        deletePrice(price.id);
                                                    }, className: `ml-2 shrink-0 text-xs ${price.id === activeId ? 'text-white/70 hover:text-white' : 'text-slate-400 hover:text-red-500'}`, children: "\u2715" })] }, price.id))) }))] }), active && _jsx(CoursePriceForm, { price: active, onChange: updateActive })] })] }), _jsxs("div", { className: "flex flex-1 flex-col overflow-hidden", children: [_jsx("div", { className: "flex border-b border-slate-200 bg-white px-4", children: ['preview', 'html'].map(tab => (_jsx("button", { onClick: () => setActiveTab(tab), className: `-mb-px border-b-2 px-4 py-3 text-sm font-medium capitalize transition ${activeTab === tab ? 'border-brand text-brand' : 'border-transparent text-slate-400 hover:text-slate-700'}`, children: tab === 'html' ? 'HTML (Inject Code)' : 'Preview' }, tab))) }), activeTab === 'preview' ? (_jsx("iframe", { srcDoc: previewDoc, className: "w-full flex-1 border-0 bg-slate-50", sandbox: "allow-same-origin" }, activeId ?? 'empty')) : (_jsxs("div", { className: "relative flex-1 overflow-auto bg-slate-900 p-4", children: [injectCode && (_jsx("button", { onClick: () => navigator.clipboard.writeText(injectCode), className: "absolute right-4 top-4 rounded bg-slate-700 px-3 py-1 text-xs text-slate-300 hover:bg-slate-600", children: "Copy" })), _jsx("pre", { className: "whitespace-pre-wrap font-mono text-xs leading-relaxed text-slate-300", children: injectCode || '// Click Save & Generate HTML to get the inject code' })] }))] })] }));
}
