...
export function generateHeroHtml(sec: HeroSection): string {
  ...
  const h1      = normalize(sec.h1,  'heroH1');      h1.size = h1Size;
  const h1hl    = normalize(sec.h1hl,'heroH1Highlight'); h1hl.size = h1Size;
