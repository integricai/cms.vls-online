import type { ArticleSection, TextValue } from '../../types/cms';
...
function style(value: TextValue | undefined, key: Parameters<typeof normalize>[1]): string {
  return `font-family:Poppins,sans-serif;${textStyle(normalize(value, key))}`;
}

export function generateArticlesHtml(data: ArticleSection): string {
