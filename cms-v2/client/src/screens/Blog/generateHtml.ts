...
const baseCss = `<style>
.vls-blog{font-family:Poppins,Arial,sans-serif;color:#0d1f3c;background:#f5f8fc;}
.vls-blog *{box-sizing:border-box;}
.vls-blog a{color:#1f73b7;text-decoration:none;}
.vls-blog-shell{max-width:1120px;margin:0 auto;padding:42px 24px;}
.vls-blog-kicker{display:inline-flex;align-items:center;border-radius:999px;background:#e5f2ff;color:#1f73b7;font-size:12px;font-weight:800;text-transform:uppercase;letter-spacing:.08em;padding:7px 12px;}
.vls-blog h1{font-size:clamp(32px,5vw,56px);line-height:1.05;margin:18px 0 14px;letter-spacing:0;color:#0d1f3c;}
...
.vls-blog-meta{display:flex;flex-wrap:wrap;gap:10px;color:#667085;font-size:13px;margin:0 0 24px;}
.vls-blog-hero{width:100%;max-height:520px;object-fit:cover;border-radius:10px;border:1px solid #dbe5f1;background:#dbe5f1;margin:14px 0 30px;}
.vls-blog-layout{display:grid;grid-template-columns:minmax(0,1fr) 260px;gap:34px;align-items:start;}
.vls-blog-article{background:#fff;border:1px solid #e1e8f1;border-radius:10px;padding:34px;}
...
.vls-blog-side{position:sticky;top:24px;background:#fff;border:1px solid #e1e8f1;border-radius:10px;padding:18px;}
...
.vls-blog-card{display:flex;flex-direction:column;background:#fff;border:1px solid #e1e8f1;border-radius:10px;overflow:hidden;min-height:100%;}
...
.vls-blog-filter.is-active{background:#0d1f3c;color:#fff;border-color:#0d1f3c;}
