...
function buildFooterMarkup(data, includeToggleScript, uid, publicFooterUrl) {
    const P = 'vlsft';
    const BG = '#0f2155';
...
function buildFooterUpdaterScript(publicFooterUrl, uid) {
...
if(!root||!root.matches||!root.matches('[data-vls-footer="1"]'))root=document.querySelector('[data-vls-footer="1"][data-vls-footer-version="hybrid-2"]')||document.querySelector('[data-vls-footer="1"]');
