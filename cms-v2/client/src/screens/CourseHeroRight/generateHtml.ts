import type { CourseHeroRightState } from '../../types/cms';
...
export function generateCourseHeroRightHtml(d: CourseHeroRightState): string {
  ...
  validItems.forEach((item, i) => {
    ...
    parts.push(
      `<div style="display:flex;align-items:flex-start;gap:14px;padding:14px 0;${i > 0 ? `border-top:1px solid ${divider};` : ''}">`
