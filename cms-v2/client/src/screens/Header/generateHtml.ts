...
var USE_ZEN=true;
function getZenlerMenuRoot(){return document.querySelector(".block.parrot.zenstyle.headers ul.dynamic_menu_texts,.zbv-blog-nav ul.dynamic_menu_texts")||document.querySelector("ul.dynamic_menu_texts:not([data-vls-ignore-menu='1'])");}
