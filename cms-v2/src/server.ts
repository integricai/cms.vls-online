...
import customPaymentOffersRouter from './routes/customPaymentOffers';
  ...
  try {
    ...
    return res.json({
      ...
      data: {
        ...
        evenDealsTestMode: parityTest,
        parityDeals: parityStatus,
        evenDeals: parityStatus,
        ...pricing,
        plans,
...
app.use('/api/custom-payment-offers', customPaymentOffersRouter);
